 ...
 * What is left in the path is exactly what `proofload-kafka` adds — the caller's
...
fun main() {
    ...
    val into = Path.of("build/reports/proofload/kafka-ceiling.md")
...
internal fun kafkaReport(measured: List<Measured>): String {
    ...
    return (
        listOf(
            ...
            "`proofload-kafka` adds: the serializer lambda, the record, the correlation header,",
