...
class LlmsTxtTest {
    ...
    private val link = Regex("""https://github\.com/matthewjones372/proofload/blob/main/([^)\s#]+)""")

    private val repoRoot: File
        get() {
            val root = System.getProperty("proofload.repoRoot")
            withClue("the build must pass -Dproofload.repoRoot; see examples/build.gradle.kts") {
