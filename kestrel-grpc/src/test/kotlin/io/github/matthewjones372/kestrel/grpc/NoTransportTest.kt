...
class NoTransportTest {
    ...
    private val entries: List<String>
        get() {
            val raw = System.getProperty("kestrel.grpc.runtimeClasspath")
            withClue("the build must pass -Dkestrel.grpc.runtimeClasspath; see build.gradle.kts") {
                raw.shouldNotBeNull()
            }
    ...
    fun `what is here is kestrel-core, grpc-api, grpc-stub and what they bring`() {
        ...
        withClue("kestrel-grpc grew a dependency: $unexpected") { unexpected.shouldBeEmpty() }
    }
}
