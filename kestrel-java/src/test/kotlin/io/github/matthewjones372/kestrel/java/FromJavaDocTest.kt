...
class FromJavaDocTest {
    ...
    private val repoRoot: File
        get() {
            ...
            withClue("the build must pass -Dkestrel.repoRoot; see build.gradle.kts") { root.shouldNotBeNull() }
            return File(root!!)
        }

    private val gate = "examples-java/src/main/java/io/github/matthewjones372/kestrel/examples/java/Checkout.java"
