...
class NoThirdPartyDependenciesTest {
    ...
    fun `the main runtime classpath is the Kotlin standard library and kestrel-core, and nothing else`() {
        val raw = System.getProperty("kestrel.report.github.runtimeClasspath")
        withClue("the build must pass -Dkestrel.report.github.runtimeClasspath; see build.gradle.kts") {
            raw.shouldNotBeNull()
        }
        ...
        withClue("kestrel-report-github must carry no library, but found: $unexpected") {
