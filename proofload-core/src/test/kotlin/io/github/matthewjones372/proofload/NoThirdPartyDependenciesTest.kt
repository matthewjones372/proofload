...
class NoThirdPartyDependenciesTest {
    ...
    fun `the main runtime classpath is the Kotlin standard library, and nothing else`() {
        val raw = System.getProperty("proofload.core.runtimeClasspath")
        withClue("the build must pass -Dproofload.core.runtimeClasspath; see build.gradle.kts") {
            raw.shouldNotBeNull()
        }
        ...
        withClue("proofload-core must stay dependency-free, but found: $unexpected") {
