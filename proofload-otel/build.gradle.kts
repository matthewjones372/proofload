...
// proofload-pelican carries pelican-core: a module that wants a collector takes
// this one, and everyone else's classpath is unchanged.
//
// Kept out of proofload-export on purpose. That module writes two formats with
...
dependencies {
    ...
    testImplementation(project(":proofload-export"))
}
