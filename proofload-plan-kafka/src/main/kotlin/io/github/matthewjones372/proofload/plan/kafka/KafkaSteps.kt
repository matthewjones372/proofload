package io.github.matthewjones372.proofload.plan.kafka
...
import io.github.matthewjones372.proofload.kafka.Topic
import io.github.matthewjones372.proofload.kafka.completions
import io.github.matthewjones372.proofload.kafka.emit
import io.github.matthewjones372.proofload.kafka.kafka
import io.github.matthewjones372.proofload.kafka.produce
import io.github.matthewjones372.proofload.plan.Declaration
import io.github.matthewjones372.proofload.plan.DeclaredStep
import io.github.matthewjones372.proofload.plan.Lowered
import io.github.matthewjones372.proofload.plan.Lowering
 ...
 *
 * Handed to `asSimulation` rather than reached for from inside `proofload-plan`,
...
class KafkaSteps(
     ...
     * `proofload emit` and a feeder are where per-user variety lives.
     */
     ...
     * through the same map: `proofload-kafka` opens the consumer with the
