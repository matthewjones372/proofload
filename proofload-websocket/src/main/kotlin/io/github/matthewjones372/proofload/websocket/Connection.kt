 ...
 * One user's socket.
 *
 * Per user rather than pooled, which is the opposite of `proofload-http`'s shared
...
val connection: SessionKey<Connection> = sessionKey("proofload.websocket.connection")
