...
- [x] **`spec-0025-coarse`** ([#14](https://github.com/matthewjones372/proofload/pull/14)) — a histogram with a chosen precision, so the
...
- [x] **`spec-0025-timeline`** ([#19](https://github.com/matthewjones372/proofload/pull/19)) — per-second recording in `RunRecorder`, merged
...
- [x] **`spec-0025-charts`** ([#22](https://github.com/matthewjones372/proofload/pull/22)) — throughput, latency and failures over time.
