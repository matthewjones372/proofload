...
- [x] **`spec-0036-outcome`** ([#26](https://github.com/matthewjones372/proofload/pull/26)) — `Outcome`, the split in `RunRecorder`, and
      ...
      the two.
- [x] **`spec-0036-callers`** ([#28](https://github.com/matthewjones372/proofload/pull/28)) — README, examples, report, JUnit and Kotest
      modules.
