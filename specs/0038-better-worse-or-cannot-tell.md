...
- [x] **`spec-0038-interval`** ([#31](https://github.com/matthewjones372/proofload/pull/31)) — the bootstrap over `Runs`, and `Comparison`
      ...
      the reason.
- [x] **`spec-0038-page`** ([#35](https://github.com/matthewjones372/proofload/pull/35)) — the comparison on the report and the assertion in
      the test frameworks.
